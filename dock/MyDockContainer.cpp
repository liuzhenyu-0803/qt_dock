    ...
    : QFrame(parent)
{
    ...
    QWidget *center_frame = new QFrame(centerHorizontalSplitter_);
...
void MyDockContainer::setCentralWidget(QWidget *widget)
{
    ...
    //if (centerWidget_) {
    //    // 移除旧的中心部件  
    //    centerWidget_->setParent(nullptr);
    //    centerWidget_ = nullptr;
    //}

    //centerWidget_ = widget;
    //if (centerWidget_) {
    //    // 将centerWidget_ 放置到 centerHorizontalSplitter_ 的中间部分  
    //    centerWidget_->setParent(centerHorizontalSplitter_);
    //    centerHorizontalSplitter_->insertWidget(1, centerWidget_);
    //}
}
